...
/**
 * Test class for Functionn.
 * Generated by PHPUnit on 2010-09-01 at 22:09:45.
 */
class FunctionnTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetName_ContainsNameSetByConstructor()
    {
        TestHelper::includeDoSomethingFunction();
        $name = 'doSomething';
        $this->function = new Functionn($name, array(1, 2));
    ...
    public function testSetArguments_EnforceReflectionException() {
        $this->function = $this->getMock('Functionn', array('getName'));
    ...
    public function testGetArguments_SetByConstructor()
    {
        ...
        $this->function = new Functionn('doSomething', $arguments);
    ...
    public function testGetDescription_SetByConstructor()
    {
        ...
        $description = 'new description';
        $this->function = new Functionn('doSomething', array(1, 2), $description);
    ...
    public function testSetPreExecutedTarget() {
        ...
        $target2 = new Functionn('doSomething2', $args, 'description');
